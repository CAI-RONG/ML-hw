...
PATH = '/Users/una/Documents/1072ML/final/data'
train = pd.read_csv(PATH + '/sales_train.csv', parse_dates=['date'], date_parser=parser)
...
for fold_, (trn_, val_) in enumerate(folds.split(X_train, Y_train)):
    ...
    #reg = xgb.XGBRegressor(n_estimators=500, max_depth=12, learning_rate=0.1, subsample=1, colsample_bytree=0.9, random_state=42, eval_metric='rmse')
    #reg.fit(trn_x, trn_y)
